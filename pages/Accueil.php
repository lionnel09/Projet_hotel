...
<div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
        <div class="block-30 item" style="background-image: url('./Admin/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
            <div class="container">
        ...
        <div class="block-30 item" style="background-image: url('./Admin/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-10">
                        <span class="subheading-sm">Welcome</span>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                            ...
                            <div class="field-icon-wrap">
                                ...
                                <input type="text" class="form-control px-3 py-3" placeholder="Your Name" name='destination'>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                            <label for="checkin">Entrée</label>
                            <div class="field-icon-wrap">
                                <div class="icon"><span class="icon-calendar"></span></div>
                                <input type="text" id="checkin_date" class="form-control" name='debut'>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                            <label for="checkin">Sortie</label>
                            <div class="field-icon-wrap">
                                <div class="icon"><span class="icon-calendar"></span></div>
                                <input type="text" id="checkout_date" class="form-control" name='sortie'>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3 align-self-end">
                            <button class="btn btn-primary btn-block" name="confirm">Check Availabilty</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="col-md-12">
                <div class="nonloop-block-13 owl-carousel">
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="./Admin/images/img_1.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="./Admin/images/img_2.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="./Admin/images/img_3.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="./Admin/images/img_4.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="./Admin/images/img_5.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="block-34">
                            <div class="image">
                                <a href="#"><img src="./Admin/images/img_6.jpg" alt="Image placeholder"></a>
                            </div>
                            <div class="text">
                                <h2 class="heading">VIP Room</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-33">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="./Admin/images/person_3.jpg" alt="Person here"></div>
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-33">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="./Admin/images/person_2.jpg" alt="Person here"></div>
                        <div class="name-text align-self-center">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-33">
                    <div class="vcard d-flex mb-3">
                        <div class="image align-self-center"><img src="./Admin/images/person_1.jpg" alt="Person here"></div>
                        <div class="name-text align-self-center">
